var L = "top", x = "bottom", R = "right", I = "left", fe = "auto", It = [L, x, R, I], pt = "start", Ot = "end", ss = "clippingParents", ze = "viewport", At = "popper", is = "reference", We = /* @__PURE__ */ It.reduce(function(n, t) {
...
function $i(n) {
  ...
  if (!t.modifiersData[s]._skip) {
    for (var i = e.mainAxis, r = i === void 0 ? !0 : i, o = e.altAxis, a = o === void 0 ? !0 : o, l = e.fallbackPlacements, h = e.padding, u = e.boundary, p = e.rootBoundary, _ = e.altBoundary, f = e.flipVariations, A = f === void 0 ? !0 : f, m = e.allowedAutoPlacements, E = t.options.placement, T = Y(E), w = T === E, O = l || (w || !A ? [oe(E)] : Di(E)), g = [E].concat(O).reduce(function(Et, Z) {
      ...
      var D = g[C], j = Y(D), $ = St(D) === pt, ot = [L, x].indexOf(j) >= 0, at = ot ? "width" : "height", M = Dt(t, {
        placement: D,
        boundary: u,
        rootBoundary: p,
        altBoundary: _,
...
function Ri(n) {
  var t = n.state, e = n.options, s = n.name, i = e.mainAxis, r = i === void 0 ? !0 : i, o = e.altAxis, a = o === void 0 ? !1 : o, l = e.boundary, h = e.rootBoundary, u = e.altBoundary, p = e.padding, _ = e.tether, f = _ === void 0 ? !0 : _, A = e.tetherOffset, m = A === void 0 ? 0 : A, E = Dt(t, {
    ...
    padding: p,
    altBoundary: u
  }), T = Y(t.placement), w = St(t.placement), O = !w, g = Ze(T), v = xi(g), b = t.modifiersData.popperOffsets, y = t.rects.reference, S = t.rects.popper, N = typeof m == "function" ? m(Object.assign({}, t.rects, {
    placement: t.placement
  })) : m, C = typeof N == "number" ? {
    mainAxis: N,
    altAxis: N
  ...
  if (b) {
    if (r) {
      var $, ot = g === "y" ? L : I, at = g === "y" ? x : R, M = g === "y" ? "height" : "width", F = b[g], Gt = F + E[ot], ct = F - E[at], qt = f ? -S[M] / 2 : 0, Ae = w === pt ? y[M] : S[M], Rt = w === pt ? -S[M] : -y[M], Xt = t.elements.arrow, Et = f && Xt ? Qe(Xt) : {
        width: 0,
        height: 0
...
me($t);
B($t);
const Oa = "offcanvas", Ca = "bs.offcanvas", Q = `.${Ca}`, Qs = ".data-api", Na = `load${Q}${Qs}`, Sa = "Escape", Kn = "show", Yn = "showing", Un = "hiding", Da = "offcanvas-backdrop", Zs = ".offcanvas.show", $a = `show${Q}`, La = `shown${Q}`, Ia = `hide${Q}`, zn = `hidePrevented${Q}`, Js = `hidden${Q}`, Pa = `resize${Q}`, Ma = `click${Q}${Qs}`, xa = `keydown.dismiss${Q}`, Ra = '[data-bs-toggle="offcanvas"]', ka = {
  backdrop: !0,
  keyboard: !0,
  scroll: !1
}, Va = {
...
B(un);
const vc = "scrollspy", bc = "bs.scrollspy", hn = `.${bc}`, Ac = ".data-api", Tc = `activate${hn}`, Xn = `click${hn}`, yc = `load${hn}${Ac}`, wc = "dropdown-item", bt = "active", Oc = '[data-bs-spy="scroll"]', xe = "[href]", Cc = ".nav, .list-group", Qn = ".nav-link", Nc = ".nav-item", Sc = ".list-group-item", Dc = `${Qn}, ${Nc} > ${Qn}, ${Sc}`, $c = ".dropdown", Lc = ".dropdown-toggle", Ic = {
  offset: null,
...
class Lt extends K {
  ...
  _keydown(t) {
    if (![Fc, Zn, Kc, Jn, Re, ts].includes(t.key))
      return;
    t.stopPropagation(), t.preventDefault();
    const e = this._getChildren().filter((i) => !et(i));
    let s;
    if ([Re, ts].includes(t.key))
      s = e[t.key === Re ? 0 : e.length - 1];
    else {
